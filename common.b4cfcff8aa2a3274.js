"use strict";(self.webpackChunkDigitalStore=self.webpackChunkDigitalStore||[]).push([[592],{1350:(p,s,n)=>{n.d(s,{a:()=>o});var t=n(6592),r=n(1571),i=n(9327);let o=(()=>{class a{constructor(c){this.apollo=c}getLocationById(c){throw new Error("Method not implemented.")}getLocation(){return this.apollo.watchQuery({query:t.Ps`
    ...
    `,variables:{searchInput:c}}).valueChanges}}return a.\u0275fac=function(c){return new(c||a)(r.LFG(i._M))},a.\u0275prov=r.Yz7({token:a,factory:a.\u0275fac,providedIn:"root"}),a})()},706:(p,s,n)=>{n.d(s,{j:()=>i});var t=n(9327),r=n(1571);let i=(()=>{class o{constructor(e){this.apollo=e}getProducts(){return this.apollo.watchQuery({query:t.Ps`
      ...
      `,variables:{id:e}}).valueChanges}}return o.\u0275fac=function(e){return new(e||o)(r.LFG(t._M))},o.\u0275prov=r.Yz7({token:o,factory:o.\u0275fac,providedIn:"root"}),o})()},9179:(p,s,n)=>{n.d(s,{r:()=>i});var t=n(9327),r=n(1571);let i=(()=>{class o{constructor(e){this.apollo=e}getreport(){return this.apollo.watchQuery({query:t.Ps`
        query getAllReports {
          getAllReports {
            id
            createdby
      ...
      `}).valueChanges}createReport(e){return this.apollo.mutate({mutation:t.Ps`
      ...
      `,variables:{report:e}})}deleteReport(e){return this.apollo.mutate({mutation:t.Ps`
        mutation ($id: Int) {
          deleteReport(id: $id)
        }
      `,variables:{id:e}})}getTotalReportCount(){return this.apollo.watchQuery({query:t.Ps`
        query getTotalReportCount {
          getTotalReportCount
        }
      `}).valueChanges}searchReport(e){return this.apollo.watchQuery({query:t.Ps`
      ...
      `,variables:{searchInput:e}}).valueChanges}getReportById(e){return this.apollo.watchQuery({query:t.Ps`
        query ($id: Int) {
